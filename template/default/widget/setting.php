...
<p>签到方式：</p>
<p><label><input type="radio" name="sign_method" id="sign_method_3" value="3" /> V3.0 (模拟客户端签到)</label></p>
<p><label><input type="radio" name="sign_method" id="sign_method_1" value="1" /> 手机网页签到</label></p>
<p>附加签到：</p>
